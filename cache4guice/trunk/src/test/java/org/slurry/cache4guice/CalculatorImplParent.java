...
public class CalculatorImplParent implements Calculator {
    ...
    @Override
    @Cached(SelfPopulatingScheduledCache = true, refreshTime = 200, slowOperation = true)
    public int serveStaleAndRefreshedDataWithWait(Integer numberA, Integer numberB, Integer sleep) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(CalculatorImplParent.class.getName()).log(Level.SEVERE, null, ex);
        }
        return result;
    }
